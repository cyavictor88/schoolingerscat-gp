...
export class MMParser {
    ...
    stretchyAdjustment() {
        ...
        async generateBoundingBoxAtText(): Promise<{ positions: number[]; indices: number[]; vertices: Float32Array; }>
        {
            // let leafLvl = 0;
            ...
            for (let i = 0; i < this.lvlStack.length; i++) {
                ...
                if (ele.text != null) {
                    ...
                    let vertexArr = await mathtxts.toTransedMesh();
        ...
        async generateBoundingBoxAtLevel(lvlnum: number): Promise<{ positions: number[]; indices: number[]; vertices: Float32Array; }>
        {
            // let leafLvl = 0;
            // for (let i = 0; i < this.lvlStack.length; i++) {
            //     if(leafLvl<this.lvlStack[i].lvl)leafLvl=this.lvlStack[i].lvl;
